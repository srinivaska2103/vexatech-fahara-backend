...
router.post('/owner/:id/notes', protect, authorizeRoles('CAFE_OWNER', 'RESTAURANT_OWNER', 'EVENT_MANAGER', 'ADMIN'), customerController.addCustomerNote);
router.put('/owner/:id/notes/:noteId', protect, authorizeRoles('CAFE_OWNER', 'RESTAURANT_OWNER', 'EVENT_MANAGER', 'ADMIN'), customerController.updateCustomerNote);
router.delete('/owner/:id/notes/:noteId', protect, authorizeRoles('CAFE_OWNER', 'RESTAURANT_OWNER', 'EVENT_MANAGER', 'ADMIN'), customerController.deleteCustomerNote);
